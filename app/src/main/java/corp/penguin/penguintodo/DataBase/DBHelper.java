package corp.penguin.penguintodo.DataBase;
...
/**
 * Created by vladislav on 01.03.16.
 */
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String SELECTION_LINE_TITLE = TASK_TITLE_COLUMN + " LIKE ?";
    ...
    public void removeTask(long timeStamp) {
        getWritableDatabase().delete(
                TASKS_TABLE, SELECTION_TIME_STAMP,
